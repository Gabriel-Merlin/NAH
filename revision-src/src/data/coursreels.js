  ...
  'gf-t1': [
    {
      ...
      blocks: [
        ...
        { t: 'p', c: 'Le commerçant ne fait que **collecter** cette TVA pour l’État, puis la lui **reverse**. Il n’est qu’un intermédiaire : la TVA n’est donc **pas une charge** pour lui. Il déduit au passage la TVA qu’il a lui-même payée sur ses achats — il ne reverse que la différence.' },
        { t: 'tip', h: 'L’idée clé', c: 'L’entreprise est un simple collecteur : TVA à reverser = TVA collectée sur les ventes − TVA déductible sur les achats.' },
      ],
    },
    {
      h: 'La comptabilité, l’histoire chiffrée de l’entreprise',
      blocks: [
        { t: 'p', c: 'Chaque opération (un achat, une vente, un salaire) laisse une trace dans le **système d’information comptable**, qui la saisit, la classe et l’enregistre. Objectif : donner une **image fidèle** de la santé de l’entreprise, utile en interne (décider) et en externe (impôts, banques).' },
        { t: 'p', c: 'Règle du jeu : la **partie double**. Toute opération est notée deux fois, de sorte que le total des débits égale toujours le total des crédits. Si ça ne tombe pas juste, c’est qu’il y a une erreur.' },
        { t: 'tip', h: 'Réflexe', c: 'Débit = crédit, toujours. C’est le garde-fou de toute la comptabilité.' },
      ],
    },
    {
      ...
      blocks: [
        ...
        { t: 'p', c: 'Non. Le four est un **investissement durable** : il sert plusieurs années. On répartit donc son coût sur sa durée d’usage grâce à l’**amortissement** (ici, environ 2 000 € par an). C’est une charge… **sans sortie d’argent** : l’argent est déjà parti à l’achat, l’amortissement ne fait que constater la perte de valeur.' },
        { t: 'tip', h: 'À distinguer', c: 'Une immobilisation (durable) s’amortit ; une charge (consommée dans l’année, comme la farine) passe en une fois.' },
      ],
    },
  ],
  'gf-t2': [
    {
      ...
      blocks: [
        ...
        { t: 'p', c: 'Parce que **résultat** et **trésorerie**, ce n’est pas la même chose. Elle a vendu (donc un bénéfice comptable), mais ses clients paient à 60 jours pendant qu’elle, elle doit acheter son stock et payer ses salariés tout de suite. Cet argent « immobilisé » par le décalage, c’est le **besoin en fonds de roulement (BFR)**.' },
        { t: 'warning', h: 'Le piège', c: 'On peut être bénéficiaire et manquer de trésorerie. Une trésorerie négative n’est pas une faillite, mais un déséquilibre à financer.' },
      ],
    },
    {
      h: 'Mesurer l’équilibre financier',
      blocks: [
        { t: 'p', c: 'Pour juger la solidité d’une entreprise, on regarde si ses ressources durables couvrent ses emplois durables (le **fonds de roulement**), on le compare au **BFR**, et la différence donne la **trésorerie**. Une trésorerie positive = un matelas de sécurité.' },
        { t: 'p', c: 'On mesure aussi la **richesse créée** : la **valeur ajoutée**, c’est ce que l’entreprise produit **moins** ce qu’elle a dû acheter à d’autres. C’est le point de départ de tout le partage (salaires, impôts, banques, propriétaires).' },
        { t: 'tip', h: 'Enchaînement', c: 'Trésorerie = fonds de roulement − BFR. C’est l’équation clé de l’équilibre financier.' },
      ],
    },
  ],
  'gf-t3': [
    {
      ...
      blocks: [
        ...
        { t: 'p', c: 'Chaque burger dégage 4 € de **marge sur coût variable**. Pour couvrir les 1 500 € de charges fixes, il faut donc 1 500 ÷ 4 = **375 burgers**. En dessous, il perd ; au-delà, il gagne. Ce point de bascule, c’est le **seuil de rentabilité**.' },
        { t: 'tip', h: 'À retenir', c: 'Au seuil de rentabilité, le résultat est nul : la marge sur coût variable couvre **exactement** les charges fixes.' },
      ],
    },
    {
      h: 'Fixe ou variable ? La décision en dépend',
      blocks: [
        { t: 'p', c: 'Les **charges variables** montent avec l’activité (plus de burgers = plus de pain) ; les **charges fixes** ne bougent pas à court terme (le loyer est le même qu’on vende 10 ou 1 000 burgers). Comprendre cette différence permet de décider : baisser un prix pour vendre plus ? accepter une grosse commande ? lancer un nouveau produit ?' },
        { t: 'warning', h: 'Piège', c: 'Un produit peut avoir une marge positive et l’entreprise perdre quand même, si le volume ne suffit pas à couvrir les coûts fixes.' },
      ],
    },
  ],
