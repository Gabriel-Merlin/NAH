...
export const DOC_STUDIES = {
  ...
  'droit-t8': {
    ...
    documents: [
      { id: 1, title: 'Document 1 — L’entreprise individuelle', text: 'Dans l’**entreprise individuelle**, il n’y a pas de personne morale nouvelle. **Depuis la réforme de 2022** (loi du 14 février 2022, statut unique en vigueur le 15 mai 2022), le **patrimoine professionnel** et le **patrimoine personnel** sont **séparés automatiquement** : le patrimoine personnel est en principe **protégé** des dettes professionnelles. *Avant 2022*, par le **principe d’unicité du patrimoine**, l’entrepreneur répondait des dettes sur **tout son patrimoine**, sauf **déclaration d’insaisissabilité** ou **EIRL**.' },
    ...
    questions: [
      { doc: 1, q: 'Depuis la réforme de 2022, dans l’entreprise individuelle, le patrimoine personnel est…', choices: ['séparé automatiquement du patrimoine professionnel et en principe protégé', 'toujours engagé pour toutes les dettes', 'transféré à une société', 'saisi par l’État'], answer: 0, explain: 'Loi du 14 février 2022 : séparation automatique des patrimoines ; le patrimoine personnel est en principe protégé des dettes professionnelles.' },
      ...
      { doc: [1, 2, 4], type: 'redac', q: 'Léa hésite entre entreprise individuelle et EURL : quelles conséquences sur son patrimoine ? Conseille-la.', answer: 'En **entreprise individuelle**, depuis la réforme de **2022**, son **patrimoine personnel** (voiture, épargne) est **séparé automatiquement** du patrimoine professionnel et donc **en principe protégé** : les créanciers du salon se paient d’abord sur les **biens professionnels**. En **EURL** (société à associé unique), une **personne morale** distincte est créée : la responsabilité de Léa est **limitée à ses apports**. Les deux solutions protègent son patrimoine personnel ; l’EURL apporte un cadre de société (statuts, comptes) mais plus de formalisme. Compte tenu de l’emprunt de 40 000 €, Léa est désormais mieux protégée qu’avant 2022 dans les deux cas.' },
  ...
  'p1-droit-t1': {
    ...
    documents: [
      { id: 1, title: 'Document 1 — Les caractères de la règle de droit', text: 'La règle de droit présente quatre caractères : elle est **générale** (elle s’applique à tous), **impersonnelle** (elle ne vise personne nommément), **obligatoire** et **coercitive** (assortie de la **contrainte / sanction de l’État** en cas de non-respect). Ses fonctions : organiser la société, pacifier les relations, protéger les personnes et sanctionner les manquements.' },
      { id: 2, title: 'Document 2 — Règle de droit et règle morale', text: 'La règle **morale** relève de la conscience individuelle ; la règle **religieuse** relève de la croyance. Ni l’une ni l’autre n’est assortie de la **contrainte de l’État**. C’est précisément ce caractère **coercitif** (la sanction étatique) qui distingue la règle de droit de ces autres règles de conduite.' },
    ...
    questions: [
      { doc: 1, q: 'La règle de droit est générale, impersonnelle, obligatoire et…', choices: ['coercitive', 'facultative', 'secrète', 'religieuse'], answer: 0, explain: 'Coercitive : assortie de la contrainte / sanction de l’État. C’est le 4ᵉ caractère.' },
      { doc: 2, q: 'Ce qui distingue une règle de droit d’une règle morale, c’est…', choices: ['son caractère coercitif (la sanction de l’État)', 'sa longueur', 'son ancienneté', 'sa langue'], answer: 0, explain: 'La morale relève de la conscience : elle n’est pas assortie de la contrainte étatique.' },
      ...
      { doc: [1, 2], type: 'redac', q: 'Qu’est-ce qui distingue la règle de droit d’une simple règle morale ?', answer: 'La règle de droit partage certains caractères avec la règle morale (elle guide les conduites), mais elle est **générale, impersonnelle, obligatoire** et surtout **coercitive** : elle est assortie de la **contrainte / sanction de l’État**. La règle **morale**, elle, relève de la **conscience** et n’est pas sanctionnée par la puissance publique. C’est donc ce caractère **coercitif** (la sanction étatique) qui distingue le droit de la morale.' },
