...
const FR = {
  ...
  iosStep1: 'Ouvre le site dans Safari (obligatoire sur iPhone).',
  iosStep2: 'Appuie sur le bouton Partager, en bas de l’écran.',
  iosStep3: 'Choisis « Sur l’écran d’accueil ».',
  iosStep4: 'Appuie sur « Ajouter ». C’est prêt !',
  andStep1: 'Ouvre le menu ⋮ (en haut à droite).',
  andStep2: 'Choisis « Installer l’application ».',
...
const ES = {
  ...
  iosStep1: 'Abre el sitio en Safari (obligatorio en iPhone).',
  iosStep2: 'Toca el botón Compartir, abajo en la pantalla.',
  iosStep3: 'Elige «Añadir a inicio».',
  iosStep4: 'Toca «Añadir». ¡Listo!',
  andStep1: 'Abre el menú ⋮ (arriba a la derecha).',
  andStep2: 'Elige «Instalar aplicación».',
