...
const FR = {
  ...
  iosStep1: 'Appuie sur le menu ⋯ (en bas à droite), puis « Partager ».',
  iosStep2: 'Fais défiler puis choisis « Sur l’écran d’accueil ».',
  iosStep3: 'Appuie sur « Ajouter ». C’est prêt ! 🎉',
  iosTip: 'Astuce : dans Safari, le bouton Partager ⎙ est directement en bas de l’écran.',
...
const EN = {
  ...
  iosStep1: 'Tap the ⋯ menu (bottom right), then “Share”.',
  iosStep2: 'Scroll and choose “Add to Home Screen”.',
  iosStep3: 'Tap “Add”. Done! 🎉',
  iosTip: 'Tip: in Safari, the Share ⎙ button is right at the bottom of the screen.',
...
const ES = {
  ...
  iosStep1: 'Toca el menú ⋯ (abajo a la derecha) y luego «Compartir».',
  iosStep2: 'Desplázate y elige «Añadir a inicio».',
  iosStep3: 'Toca «Añadir». ¡Listo! 🎉',
  iosTip: 'Consejo: en Safari, el botón Compartir ⎙ está justo abajo en la pantalla.',
