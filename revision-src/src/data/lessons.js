    ...
    cours: [
      {
        ...
        blocks: [
          ...
          { t: 'p', c: 'Chaque bloc s’organise militairement : l’**OTAN** (1949) à l’Ouest, le **pacte de Varsovie** (1955) à l’Est. La menace de destruction mutuelle instaure un « **équilibre de la terreur** » (dissuasion nucléaire). **Berlin** et l’**Allemagne**, coupées en deux, sont le symbole de cette division.' },
          { t: 'table', head: ['Date', 'Événement clé'], rows: [
            ['1945', 'Conférences de Yalta et Potsdam ; création de l’ONU'],
            ['1947', 'Rupture : doctrine Truman (« endiguement ») et plan Marshall ; en réponse, le Kominform'],
            ['1948-1949', 'Blocus de Berlin par l’URSS ; pont aérien allié'],
            ['1949', 'Naissance de la RFA et de la RDA ; création de l’OTAN ; bombe atomique soviétique ; Mao proclame la Chine populaire'],
            ['1950-1953', 'Guerre de Corée (première guerre « chaude » par procuration)'],
            ['1955', 'Pacte de Varsovie ; conférence de Bandung (non-alignés)'],
            ['1956', 'Insurrection de Budapest écrasée ; crise de Suez'],
            ['1961', 'Construction du mur de Berlin'],
            ['1962', 'Crise des missiles de Cuba : point de tension maximal (risque nucléaire)'],
            ['1963', 'Téléphone rouge ; début de la « Détente »'],
            ['1975', 'Fin de la guerre du Vietnam ; accords d’Helsinki'],
            ['1979', 'Intervention soviétique en Afghanistan (regain de tension)'],
            ['1985', 'Gorbatchev au pouvoir (perestroïka, glasnost)'],
            ['9 nov. 1989', 'Chute du mur de Berlin'],
            ['1990', 'Réunification de l’Allemagne'],
            ['1991', 'Éclatement de l’URSS : fin de la Guerre froide ; guerre du Golfe'],
          ] },
        ],
      },
      {
        h: 'La décolonisation et le tiers-monde',
        blocks: [
          { t: 'p', c: 'En parallèle, les anciennes **colonies** accèdent à l’**indépendance** : c’est la **décolonisation** (surtout 1945-1965). Elle est parfois **négociée** (Inde), parfois **violente** (Indochine, Algérie).' },
          { t: 'table', head: ['Date', 'Indépendance / événement'], rows: [
            ['1947', 'Indépendance de l’Inde et du Pakistan (Gandhi, Nehru)'],
            ['1954', 'Défaite française de Diên Biên Phu ; indépendance de l’Indochine ; début de la guerre d’Algérie'],
            ['1955', 'Conférence de Bandung : naissance du mouvement des non-alignés (« tiers-monde »)'],
            ['1956', 'Indépendance du Maroc et de la Tunisie'],
            ['1960', '« Année de l’Afrique » : indépendance de nombreuses colonies africaines'],
            ['1962', 'Indépendance de l’Algérie (accords d’Évian)'],
          ] },
        ],
      },
      {
        h: 'Vers un monde multipolaire (depuis 1991)',
        blocks: [
