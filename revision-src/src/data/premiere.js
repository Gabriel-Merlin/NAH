  ...
  chapters: [
    {
      ...
      cours: [
        {
          h: '1789 : la fin de la monarchie absolue',
          blocks: [
            { t: 'p', c: 'En 1789, la France de l’**Ancien Régime** (monarchie absolue de droit divin, société d’**ordres** : clergé, noblesse, tiers état) est en crise financière et sociale. La **Révolution** proclame des principes nouveaux : **liberté, égalité, souveraineté de la nation** (Déclaration des droits de l’homme et du citoyen).' },
            { t: 'table', head: ['Date (1789)', 'Événement'], rows: [
              ['5 mai', 'Ouverture des États généraux à Versailles'],
              ['17 juin', 'Le tiers état se proclame Assemblée nationale'],
              ['20 juin', 'Serment du Jeu de paume (ne pas se séparer avant une Constitution)'],
              ['14 juillet', 'Prise de la Bastille (symbole de l’arbitraire royal)'],
              ['4 août', 'Abolition des privilèges'],
              ['26 août', 'Déclaration des droits de l’homme et du citoyen (DDHC)'],
              ['5-6 octobre', 'Le roi est ramené de Versailles à Paris'],
            ] },
          ],
        },
        {
          h: 'De la monarchie constitutionnelle à la République (1790-1799)',
          blocks: [
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['14 juil. 1790', 'Fête de la Fédération ; Constitution civile du clergé'],
              ['juin 1791', 'Fuite de Varennes : le roi tente de fuir, il est arrêté'],
              ['sept. 1791', 'Constitution : monarchie constitutionnelle'],
              ['10 août 1792', 'Prise des Tuileries : chute de la monarchie'],
              ['20 sept. 1792', 'Victoire de Valmy contre les armées étrangères'],
              ['22 sept. 1792', 'Proclamation de la Ire République (an I)'],
              ['21 janv. 1793', 'Exécution du roi Louis XVI'],
              ['1793-1794', 'La Terreur : Comité de salut public, Robespierre'],
              ['27 juil. 1794', '9 Thermidor : chute de Robespierre, fin de la Terreur'],
              ['1795', 'Le Directoire (Constitution de l’an III)'],
            ] },
            { t: 'warning', c: 'Ne confonds pas : **1789** = début de la Révolution (fin de la monarchie absolue) ; **1792** = proclamation de la **République** ; **1793** = exécution du roi et Terreur.' },
          ],
        },
        {
          h: 'Napoléon Bonaparte : l’ascension (1769-1804)',
          blocks: [
            { t: 'p', c: '**Napoléon Bonaparte**, jeune général né en Corse, profite de l’instabilité du Directoire pour prendre le pouvoir par un **coup d’État**, puis fonde l’**Empire**.' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['15 août 1769', 'Naissance à Ajaccio (Corse)'],
              ['1784-1785', 'École militaire de Paris ; officier d’artillerie'],
              ['déc. 1793', 'Siège de Toulon : il se distingue, devient général'],
              ['5 oct. 1795', '13 Vendémiaire : il réprime une insurrection royaliste à Paris'],
              ['1796', 'Mariage avec Joséphine de Beauharnais ; début de la campagne d’Italie'],
              ['1796-1797', 'Campagne d’Italie (victoires) ; traité de Campo-Formio (1797)'],
              ['1798-1799', 'Campagne d’Égypte'],
              ['9-10 nov. 1799', '18 Brumaire : coup d’État → le Consulat (Premier consul)'],
              ['1800', 'Victoire de Marengo ; création de la Banque de France'],
              ['1801', 'Concordat avec le pape (paix religieuse)'],
              ['1802', 'Consul à vie ; Légion d’honneur ; création des lycées ; paix d’Amiens'],
            ] },
          ],
        },
        {
          h: 'L’Empire de Napoléon Ier (1804-1815)',
          blocks: [
            { t: 'p', c: 'Devenu **empereur**, Napoléon réorganise durablement la France (**Code civil** de 1804, préfets, franc germinal, université) et domine l’Europe par la guerre, avant l’effondrement.' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['21 mars 1804', 'Promulgation du Code civil (Code Napoléon)'],
              ['2 déc. 1804', 'Sacre : Napoléon empereur à Notre-Dame (en présence du pape Pie VII)'],
              ['21 oct. 1805', 'Trafalgar : défaite navale face aux Anglais (Nelson)'],
              ['2 déc. 1805', 'Austerlitz : grande victoire (« bataille des Trois Empereurs »)'],
              ['1806', 'Victoire d’Iéna ; Blocus continental contre le Royaume-Uni'],
              ['1807', 'Traités de Tilsit (apogée)'],
              ['1808', 'Intervention en Espagne (guerre d’Espagne, enlisement)'],
              ['1809', 'Victoire de Wagram (contre l’Autriche)'],
              ['1810', 'Mariage avec Marie-Louise d’Autriche'],
              ['1811', 'Naissance de son fils, l’« Aiglon » (roi de Rome)'],
              ['1812', 'Campagne de Russie : Moskova, incendie de Moscou, retraite, Bérézina'],
              ['oct. 1813', 'Leipzig (« bataille des Nations ») : lourde défaite'],
              ['6 avril 1814', 'Première abdication ; exil à l’île d’Elbe ; retour des Bourbons (Louis XVIII)'],
              ['1er mars 1815', 'Retour de l’île d’Elbe : les Cent-Jours'],
              ['18 juin 1815', 'Défaite de Waterloo (Wellington, Blücher)'],
              ['juin 1815', 'Seconde abdication ; exil à Sainte-Hélène'],
              ['5 mai 1821', 'Mort à Sainte-Hélène'],
            ] },
            { t: 'tip', c: 'Héritage de Napoléon toujours présent : **Code civil**, **préfets**, **lycées**, **Légion d’honneur**, **Banque de France**, **baccalauréat** (1808).' },
          ],
        },
        {
          h: 'Frise — Napoléon Bonaparte (1769-1821)',
          blocks: [
            { t: 'p', c: 'La vie complète de Napoléon, de sa naissance en Corse à sa mort en exil. Frise à imprimer (bouton « Enregistrer la fiche »).' },
            { t: 'frise', title: 'Napoléon Bonaparte (1769-1821)', events: [
              { date: '15 août 1769', label: 'Naissance à Ajaccio (Corse)' },
              { date: '1785', label: 'Officier d’artillerie à sa sortie de l’école militaire' },
              { date: 'déc. 1793', label: 'Siège de Toulon : il se distingue et devient général' },
              { date: '5 oct. 1795', label: '13 Vendémiaire : il mate une insurrection royaliste à Paris' },
              { date: '1796', label: 'Mariage avec Joséphine ; début de la campagne d’Italie' },
              { date: '1798-1799', label: 'Campagne d’Égypte' },
              { date: '9-10 nov. 1799', label: '**18 Brumaire** : coup d’État → il devient Premier consul' },
              { date: '1800', label: 'Victoire de Marengo ; création de la Banque de France' },
              { date: '1801', label: 'Concordat avec le pape' },
              { date: '1802', label: 'Consul à vie ; Légion d’honneur ; lycées' },
              { date: '21 mars 1804', label: 'Promulgation du **Code civil**' },
              { date: '2 déc. 1804', label: '**Sacre** : Napoléon empereur à Notre-Dame' },
              { date: '21 oct. 1805', label: 'Trafalgar : défaite navale (Nelson)' },
              { date: '2 déc. 1805', label: '**Austerlitz** : sa plus grande victoire' },
              { date: '1806', label: 'Iéna ; mise en place du Blocus continental' },
              { date: '1807', label: 'Traités de Tilsit (apogée de l’Empire)' },
              { date: '1808', label: 'Guerre d’Espagne ; création du baccalauréat' },
              { date: '1809', label: 'Victoire de Wagram' },
              { date: '1810', label: 'Mariage avec Marie-Louise d’Autriche' },
              { date: '1811', label: 'Naissance de son fils, le roi de Rome (« l’Aiglon »)' },
              { date: '1812', label: '**Campagne de Russie** : retraite désastreuse, Bérézina' },
              { date: 'oct. 1813', label: 'Défaite de Leipzig (« bataille des Nations »)' },
              { date: '6 avril 1814', label: 'Première abdication ; exil à l’île d’Elbe' },
              { date: '1er mars 1815', label: 'Retour d’Elbe : les **Cent-Jours**' },
              { date: '18 juin 1815', label: 'Défaite de **Waterloo**' },
              { date: 'juin 1815', label: 'Seconde abdication ; exil à Sainte-Hélène' },
              { date: '5 mai 1821', label: 'Mort à Sainte-Hélène' },
            ] },
          ],
        },
        {
    ...
    },
    {
      ...
      cours: [
        {
          h: '1. La Restauration et la monarchie de Juillet (1815-1848)',
          blocks: [
            { t: 'p', c: 'Après Napoléon, la **monarchie** revient avec les **Bourbons**. Louis XVIII accorde une **Charte** (1814) : le régime est une monarchie limitée, mais son frère **Charles X**, plus autoritaire, provoque une révolution. Les **Trois Glorieuses** (1830) portent au pouvoir **Louis-Philippe** et la « monarchie de Juillet », proche de la **bourgeoisie**.' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['1814', 'Restauration : Louis XVIII, roi ; il octroie la Charte constitutionnelle'],
              ['1815', 'Cent-Jours de Napoléon, puis seconde Restauration'],
              ['1824', 'Mort de Louis XVIII ; Charles X devient roi'],
              ['27-28-29 juil. 1830', 'Les Trois Glorieuses : révolution parisienne, chute de Charles X'],
              ['août 1830', 'Louis-Philippe, « roi des Français » : monarchie de Juillet'],
              ['1846-1847', 'Grave crise économique et sociale'],
            ] },
          ],
        },
        {
          h: '2. La IIe République (1848-1852)',
          blocks: [
            { t: 'p', c: 'La **révolution de février 1848** renverse la monarchie et proclame la **IIe République**, porteuse d’espoirs sociaux et démocratiques : **suffrage universel masculin** et **abolition de l’esclavage**. Mais l’écrasement des ouvriers en **juin 1848** puis l’élection de **Louis-Napoléon Bonaparte** ouvrent la voie à un nouvel Empire.' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['22-24 févr. 1848', 'Révolution : abdication de Louis-Philippe, proclamation de la IIe République'],
              ['2 mars 1848', 'Reconnaissance du « droit au travail » ; ateliers nationaux'],
              ['27 avr. 1848', 'Abolition de l’esclavage (Victor Schœlcher)'],
              ['avril 1848', 'Premières élections au **suffrage universel masculin**'],
              ['juin 1848', 'Journées de Juin : insurrection ouvrière écrasée'],
              ['10 déc. 1848', 'Louis-Napoléon Bonaparte élu président de la République'],
              ['2 déc. 1851', 'Coup d’État de Louis-Napoléon Bonaparte'],
              ['2 déc. 1852', 'Rétablissement de l’Empire : Napoléon III'],
            ] },
          ],
        },
        {
          h: '3. Le Second Empire : de l’autoritaire au libéral (1852-1870)',
          blocks: [
            { t: 'p', c: 'Le **Second Empire** commence **autoritaire** : pouvoir personnel de Napoléon III, censure, candidatures officielles, répression des opposants (**loi de sûreté générale** de 1858 après l’attentat d’Orsini). Puis, à partir de 1860, il se **libéralise** : libertés élargies, essor économique (**Haussmann** transforme Paris, chemins de fer, banques).' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['1852', 'Napoléon III empereur : Empire **autoritaire**'],
              ['dès 1853', 'Grands travaux d’Haussmann à Paris ; essor du chemin de fer'],
              ['14 janv. 1858', 'Attentat d’Orsini contre Napoléon III'],
              ['19 et 27 févr. 1858', '**Loi de sûreté générale** : répression des opposants (adoptée puis promulguée)'],
              ['1860', 'Traité de libre-échange avec le Royaume-Uni ; droit d’adresse → Empire **libéral**'],
              ['1864', 'Reconnaissance du **droit de grève**'],
              ['1868', 'Libertés de la **presse** et de **réunion** élargies'],
              ['mai 1870', 'Plébiscite : apogée apparente de l’Empire libéral'],
            ] },
          ],
        },
        {
          h: '4. La chute de l’Empire et la Commune (1870-1871)',
          blocks: [
            { t: 'p', c: 'La **guerre contre la Prusse** provoque la chute de l’Empire (défaite de **Sedan**) et la proclamation de la **IIIe République**. Dans un Paris assiégé et meurtri, l’insurrection de la **Commune** (1871) est écrasée dans le sang.' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['19 juil. 1870', 'Déclaration de guerre à la Prusse'],
              ['2 sept. 1870', 'Défaite de Sedan : Napoléon III capturé'],
              ['4 sept. 1870', 'Proclamation de la IIIe République'],
              ['28 janv. 1871', 'Capitulation de Paris assiégé ; proclamation de l’Empire allemand à Versailles'],
              ['18 mars-28 mai 1871', 'La Commune de Paris, écrasée lors de la « Semaine sanglante »'],
            ] },
          ],
        },
        {
          h: '5. L’industrialisation et les transformations sociales',
          blocks: [
            { t: 'p', c: 'Le XIXe siècle est celui de l’**industrialisation** : la **1re révolution industrielle** (charbon, machine à vapeur, textile, chemin de fer) puis la **2e** (électricité, pétrole, acier, chimie) transforment l’économie et la société.' },
            { t: 'list', c: [
              '**Urbanisation** : exode rural, croissance des villes industrielles (Nord, Est, Lyon) ;',
              'nouvelles classes : la **bourgeoisie** d’affaires (patrons, banquiers) et une nombreuse **classe ouvrière** ;',
              'dures **conditions de travail** (journées longues, travail des enfants) → **tensions sociales**, grèves ;',
              'naissance du **mouvement ouvrier** : syndicats, **socialisme**, marxisme.',
            ] },
            { t: 'table', head: ['Date', 'Repère social'], rows: [
              ['1841', 'Première loi limitant le travail des enfants'],
              ['1864', 'Reconnaissance du droit de grève'],
              ['1884', 'Loi Waldeck-Rousseau : les syndicats sont autorisés'],
              ['1892', 'Loi sur le travail des femmes et des enfants'],
            ] },
            { t: 'tip', c: 'Repères clés : **1830** et **1848** (révolutions), **1848** (suffrage universel masculin + abolition de l’esclavage), **1852-1870** (Second Empire), **1870** (IIIe République), **1871** (Commune).' },
          ],
        },
      ],
    ...
    },
    {
      ...
      cours: [
        {
          h: 'La IIIe République s’enracine (1870-1914)',
          blocks: [
            { t: 'p', c: 'Née dans la défaite de **1870**, la **IIIe République** s’installe durablement et ancre la République dans la société par des lois **fondatrices** : école, libertés, laïcité.' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['1875', 'Lois constitutionnelles fondant la IIIe République'],
              ['1881-1882', 'Lois Ferry : école primaire gratuite, obligatoire et laïque'],
              ['1884', 'Loi autorisant les syndicats ; rétablissement du divorce'],
              ['1889', 'Exposition universelle de Paris (tour Eiffel)'],
              ['1894-1906', 'Affaire Dreyfus (Zola, « J’accuse » en 1898)'],
              ['1901', 'Loi sur la liberté d’association'],
              ['1905', 'Loi de séparation des Églises et de l’État (laïcité)'],
            ] },
            { t: 'p', c: 'La France se dote aussi d’un vaste **empire colonial** (deuxième du monde), au nom d’une prétendue « mission civilisatrice » aujourd’hui critiquée.' },
          ],
        },
        {
          h: 'La Première Guerre mondiale, une guerre totale (1914-1918)',
          blocks: [
            { t: 'p', c: 'La **Grande Guerre** est une **guerre totale** : elle mobilise les sociétés entières — soldats au front, **économie de guerre**, femmes à l’usine, **propagande**, emprunts. C’est une **guerre industrielle** d’une violence inédite (tranchées, gaz, artillerie).' },
            { t: 'table', head: ['Date', 'Événement'], rows: [
              ['28 juin 1914', 'Attentat de Sarajevo (déclencheur)'],
              ['août 1914', 'Mobilisation générale, entrée en guerre ; guerre de mouvement'],
              ['sept. 1914', 'Bataille de la Marne (front stabilisé → tranchées)'],
              ['1915-1916', 'Guerre de position ; Verdun et la Somme (1916), batailles meurtrières'],
              ['1917', 'Entrée en guerre des États-Unis ; révolutions russes ; mutineries'],
              ['11 nov. 1918', 'Armistice : fin des combats'],
              ['1919', 'Traité de Versailles'],
            ] },
            { t: 'tip', c: 'Bilan : environ **10 millions de morts**, des millions de blessés et de « gueules cassées ». Repères : **1875** (lois constitutionnelles), **1881-1882** (Ferry), **1905** (laïcité), **1914-1918** (guerre), **1916** (Verdun), **1918** (armistice).' },
          ],
        },
        {
          h: 'De l’État autoritaire à l’État libéral (1848-1970)',
          blocks: [
            { t: 'p', c: 'De 1848 à 1970, la France passe peu à peu d’un **État autoritaire** à un **État démocratique et libéral** : les libertés (presse, réunion, vote, syndicats) s’élargissent et le pouvoir se sépare et se contrôle. Le meilleur exemple de cette bascule est le **Second Empire**, autoritaire à ses débuts puis « libéral ».' },
            { t: 'p', c: 'Après l’**attentat d’Orsini** contre Napoléon III (14 janvier 1858), le régime durcit la répression. Le **19 février 1858**, le Corps législatif **adopte** la **loi de sûreté générale** (« loi des suspects ») ; elle est **promulguée le 27 février 1858**. Elle permet d’**interner, exiler ou déporter sans jugement** les opposants et divise la France en circonscriptions militaires : c’est le symbole de l’**Empire autoritaire**.' },
            { t: 'table', head: ['État autoritaire (début)', 'État libéral / démocratique (ensuite)'], rows: [
              ['Pouvoir concentré (exécutif fort, empereur)', 'Séparation des pouvoirs, Parlement puissant'],
              ['Élections encadrées (candidatures officielles)', 'Suffrage libre, pluralisme des partis'],
              ['Presse censurée, réunions interdites', 'Liberté de la presse (1881), de réunion'],
              ['Opposants réprimés (loi de sûreté générale, 1858)', 'Libertés garanties, droit de grève, syndicats (1884)'],
              ['Ex. : Empire autoritaire (1852-1860)', 'Ex. : Empire libéral (1860-70), IIIe République'],
            ] },
            { t: 'frise', title: 'De l’autoritarisme à la démocratie (1848-1970)', events: [
              { date: '1848', label: 'IIe République : **suffrage universel masculin**, abolition de l’esclavage' },
              { date: '2 déc. 1851', label: 'Coup d’État de Louis-Napoléon Bonaparte' },
              { date: '1852', label: 'Second Empire **autoritaire** (Napoléon III)' },
              { date: '19 et 27 févr. 1858', label: '**Loi de sûreté générale** : répression des opposants (Empire autoritaire)' },
              { date: '1860', label: 'Début de l’Empire **libéral** (droit d’adresse au Parlement)' },
              { date: '1864', label: 'Reconnaissance du **droit de grève**' },
              { date: '1868', label: 'Libertés de la **presse** et de **réunion** élargies' },
              { date: '4 sept. 1870', label: 'Chute du Second Empire (Sedan) → **IIIe République**' },
              { date: '1875', label: 'Lois constitutionnelles de la IIIe République' },
              { date: '1881-1882', label: 'Liberté de la presse (1881) ; **lois Ferry** (école laïque, gratuite, obligatoire)' },
              { date: '1884', label: 'Syndicats autorisés ; rétablissement du divorce' },
              { date: '1905', label: 'Séparation des Églises et de l’État (laïcité)' },
              { date: '1944-1945', label: 'Droit de vote des femmes ; Sécurité sociale' },
              { date: '1946', label: 'IVe République' },
              { date: '1958', label: 'Ve République' },
              { date: '1962', label: 'Élection du président au **suffrage universel direct**' },
            ] },
            { t: 'tip', c: 'À retenir : **1858** = loi de sûreté générale (répression, Empire **autoritaire**) ; puis libéralisation (Empire **libéral** dès 1860, IIIe République, libertés de 1881-1884). « Autoritaire au départ, plus libéral ensuite ».' },
          ],
        },
      ],
