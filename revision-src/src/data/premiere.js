...
const histoireP = {
  ...
  chapters: [
    ...
    },
    {
      ...
      cours: [
        {
          h: 'Une succession de régimes (1815-1871)',
          blocks: [
            { t: 'p', c: 'Après la chute de Napoléon, la France cherche son régime : elle passe de la **monarchie** à la **République** puis à l’**Empire**, au fil de **révolutions**. C’est un siècle d’**instabilité politique**.' },
            { t: 'table', head: ['Date', 'Régime / événement'], rows: [
              ['1815', 'Restauration : retour de la monarchie (Louis XVIII)'],
              ['1824', 'Charles X, roi (monarchie plus autoritaire)'],
              ['juil. 1830', 'Les Trois Glorieuses : révolution → monarchie de Juillet (Louis-Philippe)'],
              ['févr. 1848', 'Révolution : proclamation de la IIe République'],
              ['27 avr. 1848', 'Abolition de l’esclavage (Victor Schœlcher)'],
              ['1848', 'Suffrage universel masculin ; L.-N. Bonaparte élu président'],
              ['2 déc. 1851', 'Coup d’État de Louis-Napoléon Bonaparte'],
              ['1852', 'Second Empire **autoritaire** : Napoléon III'],
              ['19 et 27 févr. 1858', 'Loi de sûreté générale (« loi des suspects »), après l’attentat d’Orsini'],
              ['1860-1870', 'Évolution vers l’Empire **libéral** (libertés peu à peu élargies)'],
              ['2 sept. 1870', 'Défaite de Sedan contre la Prusse : fin du Second Empire'],
              ['4 sept. 1870', 'Proclamation de la IIIe République'],
              ['mars-mai 1871', 'La Commune de Paris (insurrection, réprimée)'],
            ] },
          ],
        },
        {
          h: 'L’industrialisation et les transformations sociales',
          blocks: [
            { t: 'p', c: 'Le XIXe siècle est celui de l’**industrialisation** : **première révolution industrielle** (charbon, machine à vapeur, chemin de fer) puis **deuxième** (électricité, pétrole, acier). Elle bouleverse la société.' },
            { t: 'list', c: [
              '**Urbanisation** : exode rural, croissance des villes industrielles ;',
              'essor de la **bourgeoisie** d’affaires et d’une **classe ouvrière** nombreuse ;',
              'dures **conditions de travail** → **tensions sociales**, grèves et naissance du **mouvement ouvrier** (syndicats légalisés en 1884, socialisme).',
            ] },
            { t: 'tip', c: 'Repères : **1830** et **1848** (révolutions), **1848** (suffrage universel masculin + abolition de l’esclavage), **1870** (IIIe République).' },
          ],
        },
      ],
