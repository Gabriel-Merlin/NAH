        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ...
              ['Information', 'Donnée mise en contexte, porteuse de sens'],
              ['Connaissance', 'Information assimilée et réutilisable'],
              ['Système d’information (SI)', 'Ressources qui collectent, mémorisent, traitent et diffusent l’information'],
              ['Système informatique', 'Support technique du SI (matériel + logiciels)'],
              ['PGI (ERP)', 'Logiciel intégré à base de données unique, composé de modules'],
            ] },
          ],
        },
      ],
      ...
      cours: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['Table (relation)', 'Ensemble structuré de données de même nature'],
              ['Enregistrement / Champ', 'Une ligne (occurrence) / une colonne (attribut)'],
              ['Clé primaire', 'Champ qui identifie de façon unique chaque enregistrement'],
              ['Clé étrangère', 'Champ qui référence la clé primaire d’une autre table (le lien)'],
              ['SGBD', 'Logiciel qui gère la base (MySQL, PostgreSQL, Access…)'],
              ['Requête SQL', 'Instruction d’interrogation : SELECT … FROM … WHERE … ORDER BY'],
            ] },
          ],
        },
      ],
      ...
      cours: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['Cloud', 'Stockage et partage de fichiers en ligne, accessibles partout'],
              ['GED', 'Gestion électronique des documents : classer, indexer, retrouver'],
              ['Workflow', 'Circuit automatisé de validation d’un document'],
              ['Dématérialisation', 'Remplacer le papier par des fichiers numériques'],
              ['Synchrone / asynchrone', 'Collaboration en même temps / en différé'],
              ['Intelligence collective', 'Résultat du groupe supérieur à la somme des contributions individuelles'],
            ] },
          ],
        },
      ],
      ...
      cours: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['Client / Serveur', 'Machine qui demande un service / machine qui le fournit'],
              ['Protocole', 'Règles communes d’échange (TCP/IP, HTTP/HTTPS)'],
              ['Adresse IP', 'Numéro qui identifie une machine sur le réseau'],
              ['CID', 'Confidentialité, Intégrité, Disponibilité (sécurité du SI)'],
              ['Chiffrement', 'Rendre des données illisibles sans la clé'],
              ['HTML / CSS', 'Structure d’une page web / mise en forme'],
              ['Responsive', 'S’adapte à la taille de l’écran (mobile, tablette, PC)'],
            ] },
          ],
        },
      ],
