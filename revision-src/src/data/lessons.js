      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Partie double', 'Toute opération enregistrée au débit et au crédit pour un montant égal'],
            ['TVA à décaisser', 'TVA collectée − TVA déductible (ce que l’entreprise doit à l’État)'],
            ['Immobilisation / Charge', 'Bien durable inscrit à l’actif / dépense consommée dans l’année'],
            ['Amortissement', 'Répartition du coût d’une immobilisation sur sa durée d’utilisation'],
            ['Dépréciation', 'Perte de valeur réversible (≠ amortissement, définitif)'],
            ['VNC', 'Valeur nette comptable = valeur d’origine − amortissements cumulés'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['SIG', 'Soldes intermédiaires de gestion (cascade : marge → VA → EBE → … → résultat net)'],
            ['Valeur ajoutée (VA)', 'Richesse réellement créée par l’entreprise'],
            ['EBE', 'Excédent brut d’exploitation = VA + subventions − impôts et taxes − charges de personnel'],
            ['CAF', 'Capacité d’autofinancement : ressources dégagées par l’activité'],
            ['Bilan', 'Photographie du patrimoine : actif (ce qu’on possède) / passif (ressources)'],
            ['Compte de résultat', 'Charges et produits de l’exercice → bénéfice ou perte'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Charges fixes / variables', 'Indépendantes de l’activité (loyer) / proportionnelles aux ventes (matières)'],
            ['Marge sur coût variable', 'Chiffre d’affaires − charges variables'],
            ['Taux de marge sur coût variable', 'Marge sur coût variable ÷ chiffre d’affaires'],
            ['Seuil de rentabilité', 'Chiffre d’affaires pour lequel le résultat est nul'],
            ['Point mort', 'Date de l’année à laquelle le seuil de rentabilité est atteint'],
            ['Charge directe / indirecte', 'Affectable à un produit / à répartir entre plusieurs'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Organisation', 'Groupe humain structuré (moyens, division du travail, règles) réuni pour un but commun'],
            ['Finalité', 'Raison d’être durable de l’organisation (≠ objectif, but précis et mesurable)'],
            ['Efficacité', 'Atteindre l’objectif fixé'],
            ['Efficience', 'Atteindre l’objectif au moindre coût'],
            ['Ressource immatérielle', 'Actif non physique difficile à copier : marque, savoir-faire, brevet, réputation'],
            ['Chaîne de valeur', 'Enchaînement des activités qui créent de la valeur pour le client'],
            ['Compétitivité-prix', 'Capacité à s’imposer par un prix plus bas'],
            ['Compétitivité hors-prix', 'Capacité à s’imposer par la qualité, l’innovation, l’image, les délais'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Management stratégique', 'Décisions de long terme prises par la direction générale'],
            ['Management opérationnel', 'Décisions de court terme, au niveau de l’encadrement'],
            ['Diagnostic stratégique', 'Analyse interne (ressources) et externe (marché) avant de décider'],
            ['SWOT', 'Matrice Forces/Faiblesses (interne) et Opportunités/Menaces (externe)'],
            ['Spécialisation', 'Se concentrer sur un seul métier'],
            ['Diversification', 'Élargir l’offre à de nouveaux produits ou marchés'],
            ['Partie prenante', 'Acteur interne ou externe ayant un intérêt dans l’organisation'],
            ['Facteur de motivation (Herzberg)', 'Reconnaissance, responsabilités, intérêt du travail : motive vraiment'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['RSE', 'Prise en compte par l’organisation de l’impact de ses décisions sur la société et l’environnement'],
            ['Développement durable', 'Concilier les piliers économique, social et environnemental dans la durée'],
            ['Déontologie', 'Ensemble des règles de bonne conduite propres à une profession'],
            ['Greenwashing', 'Afficher des engagements écologiques sans preuve ni action réelle'],
            ['Donnée (data)', 'Ressource stratégique à collecter et protéger (RGPD)'],
            ['Cybersécurité', 'Protection des systèmes d’information contre les menaces'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Externalité', 'Effet d’une activité sur un tiers, non pris en compte par le prix (ex. pollution)'],
            ['Bien collectif', 'Bien non rival et non excluable, que le marché ne produit pas spontanément'],
            ['Redistribution', 'Réduction des inégalités par prélèvements et prestations'],
            ['Politique conjoncturelle', 'Action de court terme sur l’activité (budgétaire, monétaire)'],
            ['Politique structurelle', 'Transformation de l’économie à long terme'],
            ['Déficit public', 'Excédent des dépenses de l’État sur ses recettes'],
            ['Dette publique', 'Accumulation des déficits successifs de l’État'],
          ] },
        ],
      },
    ],
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ...
            ['Chômeur (BIT)', 'Personne sans emploi, disponible et en recherche active'],
            ['Taux de chômage', 'Chômeurs / population active'],
            ['Taux d’emploi', 'Actifs occupés / population en âge de travailler'],
            ['Chômage conjoncturel', 'Lié au ralentissement de l’activité'],
            ['Chômage structurel', 'Lié à l’inadéquation durable entre compétences et emplois'],
            ['Chômage frictionnel', 'Lié au temps de transition entre deux emplois'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Avantage comparatif', 'Production pour laquelle un pays est relativement le plus efficace (Ricardo)'],
            ['Division internationale du travail (DIT)', 'Spécialisation des pays selon leurs avantages comparatifs'],
            ['Libre-échange', 'Ouverture des marchés et suppression des barrières commerciales'],
            ['Protectionnisme', 'Protéger la production nationale (droits de douane, quotas, normes)'],
            ['OMC', 'Organisation mondiale du commerce : fixe les règles et arbitre les litiges'],
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ...
            ['PIB', 'Valeur des richesses créées sur un territoire en un an'],
            ['IDH', 'Indice de développement humain (revenu + santé + éducation)'],
            ...
            ['Pauvreté relative', 'Niveau de vie très inférieur au niveau de vie médian du pays'],
          ] },
        ],
      },
    ],
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Problématiser', 'Montrer qu’une question évidente cache un vrai problème (une tension)'],
            ['Notion', 'Grand concept du programme abordé par des questions (art, liberté, vérité…)'],
            ['Repère', 'Couple de concepts à distinguer pour raisonner (légal/légitime…)'],
            ['Légal', 'Conforme à la loi'],
            ['Légitime', 'Conforme à la justice, jugé juste'],
            ['Objectif / Subjectif', 'Indépendant de moi / propre à chacun'],
          ] },
        ],
      },
    ...
    cours: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
          { t: 'table', head: ['Terme', 'Définition'], rows: [
            ['Dissertation', 'Réponse argumentée et progressive à une question philosophique'],
            ['Problématique', 'Le vrai problème dégagé du sujet (la tension à résoudre)'],
            ['Thèse', 'Ce que l’auteur (ou l’élève) cherche à prouver'],
            ['Argument', 'Raison qui appuie une thèse, illustrée par un exemple'],
            ['Explication de texte', 'Rendre compte de la thèse et du raisonnement d’un texte, puis en discuter'],
            ['Mouvement (du texte)', 'Étape logique de l’argumentation d’un texte'],
          ] },
        ],
      },
    ],
