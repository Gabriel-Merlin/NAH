        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['Compétence', 'Savoirs + savoir-faire + savoir-être (ce qu’on sait faire réellement)'],
              ['Qualification', 'Reconnaissance officielle des compétences (diplôme, classification)'],
              ['GPEC', 'Gestion prévisionnelle des emplois et des compétences'],
              ['Rémunération', 'Salaire de base + primes + périphériques (intéressement, avantages)'],
              ['Équité interne / externe', 'Cohérence des salaires dans l’organisation / par rapport au marché'],
              ['Motivation', 'Ce qui pousse le salarié à agir et à fournir des efforts'],
              ['Implication', 'Engagement durable du salarié envers son organisation'],
            ] },
          ],
        },
      ],
      ...
      cours: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['Groupe', 'Individus réunis autour d’un but commun et qui interagissent'],
              ['Statut', 'Position occupée dans le groupe'],
              ['Rôle', 'Comportement attendu lié à un statut'],
              ['Cohésion', 'Force qui unit les membres d’un groupe'],
              ['Conformisme', 'Alignement excessif sur le groupe qui étouffe les avis divergents'],
              ['Conflit latent / ouvert', 'Tension larvée / opposition déclarée et visible'],
              ['Médiation / Arbitrage', 'Un tiers aide à trouver un accord / un tiers impose la décision'],
            ] },
          ],
        },
      ],
      ...
      cours: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['Émetteur / Récepteur', 'Celui qui envoie / celui qui reçoit et décode le message'],
              ['Feedback', 'Réponse du récepteur qui referme la boucle de communication'],
              ['Bruit', 'Ce qui parasite le message (matériel ou sémantique)'],
              ['Communication non verbale', 'Gestes, regard, posture ; le para-langage = ton, débit'],
              ['Écoute active', 'Attention + empathie + reformulation'],
              ['Convaincre / Persuader', 'S’appuyer sur la raison / sur l’émotion'],
            ] },
          ],
        },
      ],
      ...
      cours: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: 'p', c: '📖 **Définitions clés à mémoriser**' },
            { t: 'table', head: ['Terme', 'Définition'], rows: [
              ['OST (Taylor)', 'Organisation scientifique du travail : division et parcellisation des tâches'],
              ['Enrichissement des tâches', 'Ajouter des tâches plus qualifiées (contrôle, décision)'],
              ['QVT', 'Qualité de vie au travail : bien-être des salariés au service de la performance'],
              ['Turnover', 'Taux de rotation / de départs des salariés'],
              ['Absentéisme', 'Taux d’absences des salariés'],
              ['Climat social', 'Ambiance et qualité des relations dans l’organisation'],
              ['Dialogue social / CSE', 'Échanges avec les représentants du personnel (comité social et économique)'],
            ] },
          ],
        },
      ],
