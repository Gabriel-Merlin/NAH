...
const FR = {
  ...
  rewardClaimedToday: 'Récompense du jour récupérée', rewardComeToday: 'Ouvre l’appli chaque jour pour gagner de l’XP', daysLeftS: 'jour restant', daysLeftP: 'jours restants',
...
const EN = {
  ...
  rewardClaimedToday: 'Today’s reward collected', rewardComeToday: 'Open the app every day to earn XP', daysLeftS: 'day left', daysLeftP: 'days left',
...
const ES = {
  ...
  rewardClaimedToday: 'Recompensa de hoy recogida', rewardComeToday: 'Abre la app cada día para ganar XP', daysLeftS: 'día restante', daysLeftP: 'días restantes',
